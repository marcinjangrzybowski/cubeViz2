...
example3d = combineDrawings $ [
            Drawing [( unitHyCube 3  , SShape ( Rgba 1.0 1.0 0.0 1.0 )  )]
             ,
             (translate [0.2 , 0.2, 0.1] $ scale 0.6 (Drawing [ ( unitHyCube 3  , Mask  ) ]))
             , 
             (translate [0 , 0 , 0] $ scale 0.4 (Drawing [ ( unitHyCube 3  , MShape ( Rgba 1.0 0.0 0.0 1.0 )  ) ]))
             ,
             (translate [0 , 0.5 , 0] $ scale 0.4 (Drawing [ ( unitHyCube 3  , MShape ( Rgba 1.0 0.0 1.0 1.0 )  ) ]))
             ,
             (translate [0.5 , 0.5 , 0.2 ] $ scale 0.4 (Drawing [ ( unitHyCube 3  , SShape ( Rgba 0.0 1.0 1.0 1.0 )  ) ]))
            ]
