...
data CubCell b =
    CCHole (Map.Map SubFace (Cub b))
  | CCTerm (FromLI Face (Cub b)) VarIndex [IExpr]  
  deriving (Show ,  Functor)

data Cub b =
    Cub (CubCell b)
  | Hcomp b Name (Map.Map SubFace (Cub b)) (Cub b)
  deriving (Show ,  Functor)
...
data AddrStatus =
    ASInvalidAddress
  | ASValidAddress  ValidAddrStatus
